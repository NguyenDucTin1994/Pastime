...
public class PathSplineTrack : MonoBehaviour {
	...
	void Update () {
		...
		trackPosition += Time.deltaTime * 0.03f;// * Input.GetAxis("Column"); // Uncomment to have the forward and backwards controlled by the directional arrows
