...
namespace DentedPixel.LTExamples
{
    ...
    public class TestingUnitTests : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            // This test works when it is positioned last in the test queue (probably worth fixing when you have timeInterval)
            ...
            // Tween with timeInterval of zero is needs to be set to it's final value
            ...
            LeanTween.color(cubeAlpha2, Color.cyan, 0.3f).setOnComplete(() => {
                ...
                LeanTest.expect(onStartTime >= 0f && onStartTime < Time.time, "ON START", "onStartTime:" + onStartTime + " timeInterval:" + Time.time);
            }).setOnStart(() => {
        ...
        IEnumerator timeBasedTesting()
        {
            ...
            // float timeElapsedNormal = Time.timeInterval;
