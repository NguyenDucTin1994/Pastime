...
//		Debug.Log("delay:"+delay+" count:"+this.current.count+" this.current.totalDelay:"+this.current.totalDelay);
	...
	/**
	* Add a timeInterval delay to the sequence
	* @method append (delay)
	* @param {float} delay:float amount of timeInterval to add to the sequence
...
//			Debug.Log("seq.count:" + count + " seq.tween:" + seq.tween);
			...
			if (seq.tween != null) {
//			Debug.Log("seq.tween.timeInterval * timeScale:" + seq.tween.timeInterval * timeScale + " seq.totalDelay:"+seq.totalDelay +" timeInterval:"+seq.tween.timeInterval+" seq.tween.delay:"+seq.tween.delay);
