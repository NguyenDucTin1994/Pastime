namespace Chess
{
    ...
    public class Board
    {
        ...
        // Stores piece code for each square on the currentBoard.
        // Piece code is defined as piecetype | colour code
        public int[] Square; // square[] store array of int (int can represent for Piece (pieceType,Color) - bit 0-2 store GetPieceTypeBinary
                                                                                                            // bit 3,4 store Color  
        ...
        // Make a move on the currentBoard
        ...
        public void DoMove(Move move, bool inSearch = false)
        {
            ...
            int capturedPieceType = Piece.GetPieceTypeBinary(Square[moveTo]);
            int movePiece = Square[moveFrom];
            int movePieceType = Piece.GetPieceTypeBinary(movePiece);
            ...
            // Move piecesCaptureUI in piece lists
            ...
            // Update the currentBoard representation:
            ...
            ZobristKey ^= Zobrist.piecesArray[Piece.GetPieceTypeBinary(pieceOnTargetSquare), ColourToMoveIndex, moveTo];
        ...
        // Undo a move previously made on the currentBoard
        public void UndoMove(Move move, bool inSearch = false)
        {
            ...
            int toSquarePieceType = Piece.GetPieceTypeBinary(Square[movedTo]);
        ...
        public void LoadPosition(string fen)
        {
            ...
            // OK CanvasManager.instance.TurnOnCanvas(CanvasType.Promotion);

            // Load piecesCaptureUI into currentBoard array and piece lists
            for (int squareIndex = 0; squareIndex < 64; squareIndex++)
            {
                ...
                if (piece != Piece.None)
                {
                    ...
                    int pieceColourIndex = (Piece.CompareColor(piece, Piece.White)) ? WhiteIndex : BlackIndex;
            ...
            #region CÂU LỆNH KO ĐI VÀO KHI CHẠY ANDROID
            ZobristKey = Zobrist.CalculateZobristKey(this);
            #endregion

            // Not Ok CanvasManager.instance.TurnOnCanvas(CanvasType.Promotion);
        }
